////COLLADA-DOM
////This is a static xmlversion.h file modified for CMake to use without
////the configuratin step, in case libxml2 is not installed on the system.
